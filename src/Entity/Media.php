...
class Media
{
    ...
    public function getCastProperty(): array
    {
        return $this->cast_property;
    }

    public function setCastProperty(array $cast_property): static
    {
        $this->cast_property = $cast_property;
